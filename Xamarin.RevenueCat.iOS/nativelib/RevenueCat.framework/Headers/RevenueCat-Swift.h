...
@property (nonatomic, readonly, copy) NSArray<RCStoreTransaction *> * _Nonnull nonSubscriptionTransactions;
...
/// The underlying data for this <code>CustomerInfo</code>.
/// note:
...
/// The underlying data for this <code>EntitlementInfo</code>.
/// note:
/// the content and format of this data isn’t documented and is subject to change,
/// it’s only meant for debugging purposes or for getting access to future data
/// without updating the SDK.
...
/// <ul>
///   <li>
///     <code>Purchases/getPromotionalOffer(forProductDiscount:product:)</code>
///   </li>
///   <li>
///     <code>Purchases/getPromotionalOffer(forProductDiscount:product:completion:)</code>
///   </li>
///   <li>
///     <code>StoreProduct/getEligiblePromotionalOffers()</code>
///   </li>
///   <li>
///     <code>Purchases/getEligiblePromotionalOffers(forProduct:)</code>
///   </li>
///   <li>
...
///   </li>
///   <li>
///     <code>getPromotionalOffer(forProductDiscount:product:)</code>
///   </li>
/// </ul>
/// \param product The <code>StoreProduct</code> the user intends to purchase.
///
...
/// If a user could have more than one entitlement at a time, use <code>beginRefundRequest(forEntitlement:)</code> instead.
